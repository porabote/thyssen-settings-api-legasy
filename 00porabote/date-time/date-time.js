class DateTime
{
    ...
    setDateMask(params)
    {
        ...
        replace(/YY/g, (date.getFullYear().toString().replace(/^.{2}/, ''))).
        replace(/MMMM/g, this.monthsList[date.getMonth()][(params['declension']) ? 2 : 1]).
        replace(/MMM/g, this.monthsList[date.getMonth()][0]).
        replace(/MM/g, (date.getMonth() < 10) ? '0'+date.getMonth() : date.getMonth()).
        replace(/M/g, date.getMonth()).
        replace(/DD/g, (date.getDate() < 10) ? '0'+date.getDate() : date.getDate()).
        replace(/D/g, date.getDate()).
        replace(/hh/g, (date.getHours() < 10) ? '0'+date.getHours() : date.getHours()).
